  ...
  <div>
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="createdAt" label="领用时间" sortable />
...
import { listOrderProductWithReceiverAPI } from "../../api/order-product";
...
const getList = () => {
  ...
  if (defaultList.value.dateState == 2) {
    listOrderProductWithReceiverAPI(defaultList.value)
      .then((res) => {
